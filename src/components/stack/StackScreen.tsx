...
import { mainStacks, subStacks } from "../data/stackData";
      ...
      <div className="h-full max-w-7xl mx-auto py-3 px-6 md:px-12">
        <div className="h-full p-6 md:p-12 rounded-2xl">
          <div className="flex items-center pb-6 md:pb-12">
            ...
            <p className="text-xs md:text-sm text-pf-gray-200 dark:text-pf-gray-100">기술 스택</p>
          </div>
          <div className="flex flex-col gap-6 md:gap-12">
            <StackMain mainStacks={mainStacks} />
            <StackSub subStacks={subStacks} />
          </div>
        </div>
      </div>
    </div>
